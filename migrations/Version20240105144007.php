 ...
 */
final class Version20240105144007 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE Ordinateurs (id INT AUTO_INCREMENT NOT NULL, numero_serie INT NOT NULL, etat_disponible TINYINT(1) NOT NULL, marque VARCHAR(40) NOT NULL, modele VARCHAR(40) NOT NULL, date_sortie DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', date_acquisition DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', systeme VARCHAR(255) DEFAULT NULL, cpu VARCHAR(255) DEFAULT NULL, gpu VARCHAR(255) DEFAULT NULL, memoire JSON NOT NULL COMMENT \'(DC2Type:json)\', disques JSON NOT NULL COMMENT \'(DC2Type:json)\', notes VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
