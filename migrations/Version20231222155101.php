 ...
 */
final class Version20231222155101 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Creating Cellullaires, Gestionnaires, Utilisateurs and Ordinateurs tables...';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE Gestionnaires (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_93EAE22DE7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Ordinateurs (id INT AUTO_INCREMENT NOT NULL, numero_serie INT NOT NULL, etat_disponible TINYINT(1) NOT NULL, marque VARCHAR(40) NOT NULL, modele VARCHAR(40) NOT NULL, date_acquisition DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', date_sortie DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', systeme VARCHAR(255) NOT NULL, cpu VARCHAR(255) NOT NULL, gpu VARCHAR(255) NOT NULL, memoire INT DEFAULT NULL, disques JSON NOT NULL, notes VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
